...
该方式会读取 `APP_HOST` 和 `APP_PORT` 启动服务。


## 冲突排查

如果你遇到“风格参数冲突/不合法”问题，请确认 `style` 仅使用以下值：`business | minimal | creative | education`。

如果你遇到“生成页数冲突”问题，请确认 `max_slides` 在 `1~30` 之间。
